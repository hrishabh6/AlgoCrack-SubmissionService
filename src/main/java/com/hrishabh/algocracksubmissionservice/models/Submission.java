 ...
 * Cross-service JPA relationships (User, Question) have been removed.
 * Uses scalar userId (String) and questionId (Long) instead.
 */
@Entity
@Getter
@Setter
...
public class Submission {
    ...
    /**
     * User who submitted the code — scalar reference (no JPA relationship)
     */
    ...
    /**
     * Question being solved — scalar reference (no JPA relationship)
     */
